...
public class TwentyFourHourFormatValidator implements ConstraintValidator<TwentyFourHourFormat, String> {

    private final Pattern timePattern = Pattern.compile("([01]?[0-9]|2[0-3]):[0-5][0-9]");

    @Override
    public void initialize(TwentyFourHourFormat constraintAnnotation) {
